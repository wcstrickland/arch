...
class DecomposedMetadataTransformer extends baseMetadataTransformer_1.BaseMetadataTransformer {
    ...
    toSourceFormat(component, mergeWith) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const writeInfos = [];
            const childrenOfMergeComponent = new collections_1.ComponentSet(mergeWith === null || mergeWith === void 0 ? void 0 : mergeWith.getChildren());
            const { type, fullName: parentFullName } = component;
            let parentXmlObject;
            const composedMetadata = yield this.getComposedMetadataEntries(component);
            for (const [tagKey, tagValue] of composedMetadata) {
                const childTypeId = (_a = type.children) === null || _a === void 0 ? void 0 : _a.directories[tagKey];
                if (childTypeId) {
                    ...
                    for (const value of tagValues) {
                        ...
                        // operation now and mark it as merged in the state
                            ...
                            const mergeChild = childrenOfMergeComponent
                        ...
                        // the state
                        else if (!((_b = this.getDecomposedState(childComponent)) === null || _b === void 0 ? void 0 : _b.foundMerge)) {
            ...
            if (!parentState && parentXmlObject) {
                ...
                else if (!(parentState === null || parentState === void 0 ? void 0 : parentState.foundMerge)) {
    ...
    getComposedMetadataEntries(component) {
        return __awaiter(this, void 0, void 0, function* () {
            const composedMetadata = (yield component.parseXml())[component.type.name];
    ...
    setDecomposedState(forComponent, props = {}) {
        ...
        const withOrigin = Object.assign({ origin: (_a = forComponent.parent) !== null && _a !== void 0 ? _a : forComponent }, props);
        this.context.decomposition.setState((state) => {
            var _a;
            state[key] = Object.assign((_a = state[key]) !== null && _a !== void 0 ? _a : {}, withOrigin);
        });
    }
    ...
    getDefaultOutput(component) {
        ...
        const baseComponent = (parent !== null && parent !== void 0 ? parent : component);
        let output = `${childName !== null && childName !== void 0 ? childName : baseName}.${component.type.suffix}${common_1.META_XML_SUFFIX}`;
        if ((parent === null || parent === void 0 ? void 0 : parent.type.strategies.decomposition) === "folderPerType" /* FolderPerType */) {
            output = path_1.join(type.directoryName, output);
        }
        return path_1.join(baseComponent.getPackageRelativePath(baseName, 'source'), output);
    }
}
