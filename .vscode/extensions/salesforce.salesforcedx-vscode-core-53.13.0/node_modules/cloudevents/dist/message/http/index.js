...
function parseBinary(message, version) {
    ...
    const eventObj = {};
    const parserMap = version === "0.3" /* V03 */ ? headers_1.v03binaryParsers : headers_1.v1binaryParsers;
...
function parseStructured(message, version) {
    ...
    const eventObj = {};
    const parserMap = version === "0.3" /* V03 */ ? headers_1.v03structuredParsers : headers_1.v1structuredParsers;
