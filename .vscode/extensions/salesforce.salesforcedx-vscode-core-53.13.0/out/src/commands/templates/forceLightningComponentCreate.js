...
class LibraryForceLightningComponentCreateExecutor extends libraryBaseTemplateCommand_1.LibraryBaseTemplateCommand {
    constructor() {
        super(...arguments);
        this.executionName = messages_1.nls.localize('force_lightning_component_create_text');
        this.telemetryName = 'force_lightning_component_create';
        this.metadataTypeName = metadataTypeConstants_1.AURA_TYPE;
        this.templateType = templates_1.TemplateType.LightningComponent;
    }
    getOutputFileName(data) {
        return data.fileName;
    }
    getFileExtension() {
        return metadataTypeConstants_1.AURA_COMPONENT_EXTENSION;
    }
...
exports.LibraryForceLightningComponentCreateExecutor = LibraryForceLightningComponentCreateExecutor;
...
function forceLightningComponentCreate() {
...
exports.forceLightningComponentCreate = forceLightningComponentCreate;
function forceInternalLightningComponentCreate(sourceUri) {
    return __awaiter(this, void 0, void 0, function* () {
        const createTemplateExecutor = new LibraryForceLightningComponentCreateExecutor();
...
exports.forceInternalLightningComponentCreate = forceInternalLightningComponentCreate;
//# sourceMappingURL=forceLightningComponentCreate.js.map