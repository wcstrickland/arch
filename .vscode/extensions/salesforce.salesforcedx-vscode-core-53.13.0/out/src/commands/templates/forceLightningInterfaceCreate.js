...
class LibraryForceLightningInterfaceCreateExecutor extends libraryBaseTemplateCommand_1.LibraryBaseTemplateCommand {
    constructor() {
        super(...arguments);
        this.executionName = messages_1.nls.localize('force_lightning_interface_create_text');
        this.telemetryName = 'force_lightning_interface_create';
        this.metadataTypeName = metadataTypeConstants_1.AURA_TYPE;
        this.templateType = templates_1.TemplateType.LightningInterface;
    }
...
exports.LibraryForceLightningInterfaceCreateExecutor = LibraryForceLightningInterfaceCreateExecutor;
