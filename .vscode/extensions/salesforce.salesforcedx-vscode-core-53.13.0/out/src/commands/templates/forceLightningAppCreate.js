...
class LibraryForceLightningAppCreateExecutor extends libraryBaseTemplateCommand_1.LibraryBaseTemplateCommand {
    constructor() {
        super(...arguments);
        this.executionName = messages_1.nls.localize('force_lightning_app_create_text');
        this.telemetryName = 'force_lightning_app_create';
        this.metadataTypeName = metadataTypeConstants_1.AURA_TYPE;
        this.templateType = templates_1.TemplateType.LightningApp;
    }
...
exports.LibraryForceLightningAppCreateExecutor = LibraryForceLightningAppCreateExecutor;
