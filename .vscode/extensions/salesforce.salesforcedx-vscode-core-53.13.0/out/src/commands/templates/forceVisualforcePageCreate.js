...
class LibraryForceVisualForcePageCreateExecutor extends libraryBaseTemplateCommand_1.LibraryBaseTemplateCommand {
    constructor() {
        super(...arguments);
        this.executionName = messages_1.nls.localize('force_visualforce_page_create_text');
        this.telemetryName = 'force_visualforce_page_create';
        this.metadataTypeName = metadataTypeConstants_1.VISUALFORCE_PAGE_TYPE;
        this.templateType = templates_1.TemplateType.VisualforcePage;
    }
...
exports.LibraryForceVisualForcePageCreateExecutor = LibraryForceVisualForcePageCreateExecutor;
