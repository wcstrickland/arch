...
class LibraryForceLightningLwcCreateExecutor extends libraryBaseTemplateCommand_1.LibraryBaseTemplateCommand {
    constructor() {
        super(...arguments);
        this.executionName = messages_1.nls.localize('force_lightning_lwc_create_text');
        this.telemetryName = 'force_lightning_web_component_create';
        this.metadataTypeName = metadataTypeConstants_1.LWC_TYPE;
...
exports.LibraryForceLightningLwcCreateExecutor = LibraryForceLightningLwcCreateExecutor;
