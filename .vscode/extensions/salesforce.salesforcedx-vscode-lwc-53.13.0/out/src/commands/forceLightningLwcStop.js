        ...
        try {
            if (devServerService_1.DevServerService.instance.isServerHandlerRegistered()) {
                ...
                commands_1.notificationService
                    .showSuccessfulExecution(messages_1.nls.localize('force_lightning_lwc_stop_text'), channel_1.channelService)
                    .catch();
                telemetry_1.telemetryService.sendCommandEvent(logName, startTime);
            }
            else {
                commands_1.notificationService.showWarningMessage(messages_1.nls.localize('force_lightning_lwc_stop_not_running'));
            }
        }
        catch (e) {
