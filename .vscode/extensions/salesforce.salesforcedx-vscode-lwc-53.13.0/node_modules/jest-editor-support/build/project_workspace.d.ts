...
export default class ProjectWorkspace {
    ...
    constructor(rootPath: string, pathToJest: string, pathToConfig: string, localJestMajorVersion: number, outputFileSuffix?: string, collectCoverage?: boolean, debug?: boolean);
}
