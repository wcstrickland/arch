...
function isKnowAttributeOnElement(tagName, attributeName) {
    ...
    return (Array.isArray(HTML_ATTRIBUTES_REVERSE_LOOKUP[attributeName]) &&
        HTML_ATTRIBUTES_REVERSE_LOOKUP[attributeName].includes(tagName));
}
exports.isKnowAttributeOnElement = isKnowAttributeOnElement;
...
const HTML_ATTRIBUTES_REVERSE_LOOKUP = {
    'xlink:href': [
        'use',
    ],
    'role': [],
