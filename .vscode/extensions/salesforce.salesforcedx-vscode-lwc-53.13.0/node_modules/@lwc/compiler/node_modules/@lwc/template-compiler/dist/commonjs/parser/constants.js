...
exports.IF_RE = /^if:/;
exports.VALID_IF_MODIFIER = new Set([
    'true',
    'false',
    'strict-true',
]);
...
exports.ARIA_RE = new RegExp('^(aria)-[' + ATTRIBUTE_NAME_CHAR + ']*$');
exports.DATA_RE = new RegExp('^(data)-[' + ATTRIBUTE_NAME_CHAR + ']*$');
exports.SVG_TAG_WHITELIST = new Set([
    'svg',
    'a',
    'altglyph',
    'altglyphdef',
...
exports.MATHML_TAG_BLACKLIST = new Set([
    'script',
]);
exports.GLOBAL_ATTRIBUTE_SET = new Set([
...
exports.VOID_ELEMENT_SET = new Set([
...
exports.HTML_TAG_BLACKLIST = new Set([
    'base',
    'link',
    'meta',
    'script',
...
exports.HTML_ATTRIBUTES_REVERSE_LOOKUP = {
    'xlink:href': [
        'use',
    ],
    'role': [],
