...
function generateSecureImports(additionalImports) {
    ...
    return t.importDeclaration([t.importSpecifier(t.identifier(constants_1.SECURE_REGISTER_TEMPLATE_METHOD_NAME), t.identifier(constants_1.SECURE_REGISTER_TEMPLATE_METHOD_NAME)), ...imports], t.stringLiteral(constants_1.LWC_MODULE_NAME));
}
function generateInlineStylesImports(state) {
    return state.inlineStyle.imports;
}
function format(templateFn, state, options) {
    ...
    const templateBody = [
        templateFn,
        t.exportDefaultDeclaration(t.callExpression(t.identifier(constants_1.SECURE_REGISTER_TEMPLATE_METHOD_NAME), [t.identifier(constants_1.TEMPLATE_FUNCTION_NAME)]))
    ];
    return t.program([
        ...imports,
        ...templateBody,
