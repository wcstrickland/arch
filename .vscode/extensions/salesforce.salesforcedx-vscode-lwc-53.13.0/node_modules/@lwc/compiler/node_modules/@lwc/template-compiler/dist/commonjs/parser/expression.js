        ...
        traverse_1.default(parsed, {
            ...
            MemberExpression: {
                exit(path) {
                    ...
                    errors_1.invariant(!ir_1.isBoundToIterator(objectIdentifier, element) || propertyIdentifier.name !== ITERATOR_NEXT_KEY, errors_1.ParserDiagnostics.MODIFYING_ITERATORS_NOT_ALLOWED);
                },
            },
        });
        return expression;
