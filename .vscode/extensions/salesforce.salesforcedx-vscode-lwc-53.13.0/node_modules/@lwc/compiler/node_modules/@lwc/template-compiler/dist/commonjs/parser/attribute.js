...
function isXLinkAttribute(attrName) {
    return attrName === constants_1.XLINK_HREF;
}
exports.isXLinkAttribute = isXLinkAttribute;
...
function isDeprecatedIsAttribute(attrName) {
    return attrName === 'lwc-deprecated:is';
}
exports.isDeprecatedIsAttribute = isDeprecatedIsAttribute;
...
function isAriaOrDataOrFmkAttribute(attrName) {
    return (isAriaAttribute(attrName) ||
...
function isCustomElementAttribute(attrName) {
    return (attrName === 'lwc-deprecated:is' ||
        attrName === 'key' ||
        attrName === 'slot' ||
        !!attrName.match(constants_1.DATA_RE));
}
...
function attributeToPropertyName(element, attrName) {
    ...
    if (shouldCamelCaseAttribute(element, attrName)) {
        propName = constants_1.ATTRS_PROPS_TRANFORMS[propName] || propName;
    }
    return camelcase_1.default(propName);
}
