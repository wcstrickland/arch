 ...
 */
export declare function getPropertyBindingTemplateDeclaration(document: TextDocument, position: Position, htmlDocument: HTMLDocument): Location | null;
/**
 ...
 */
export declare function getPropertyBindingValue(document: TextDocument, position: Position, htmlDocument: HTMLDocument): string | null;
//# sourceMappingURL=lwcExtensions.d.ts.map