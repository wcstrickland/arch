...
class LogService {
    ...
    tail(org, tailer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const options = new core_1.StreamingClient.DefaultOptions(org, STREAMING_LOG_TOPIC, this.streamingCallback.bind(this));
            options.setSubscribeTimeout(kit_1.Duration.minutes(constants_1.LOG_TIMER_LENGTH_MINUTES));
            const stream = yield core_1.StreamingClient.create(options);
