...
class AsyncTests {
    ...
    runTests(options, codeCoverage = false, exitOnTestRunId = false, progress, token) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield this.formatAsyncResults(asyncRunResult, utils_1.getCurrentTime(), codeCoverage, testRunSummary, progress);
            }
            catch (e) {
    ...
    reportAsyncResults(testRunId, codeCoverage = false, token) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield this.formatAsyncResults({ queueItem, runId: testRunId }, utils_1.getCurrentTime(), codeCoverage, testRunSummary);
            }
            catch (e) {
                throw diagnosticUtil_1.formatTestErrors(e);
            }
    ...
    checkRunStatus(testRunId, progress) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            if (!utils_2.isValidTestRunID(testRunId)) {
            ...
            const testRunSummaryResults = (yield this.connection.tooling.autoFetchQuery(testRunSummaryQuery));
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = {
                summary: {
                    ...
                    passRate: utils_2.calculatePercentage(globalTests.passed, testResults.length),
                    failRate: utils_2.calculatePercentage(globalTests.failed, testResults.length),
                    skipRate: utils_2.calculatePercentage(globalTests.skipped, testResults.length),
                    testStartTime: utils_1.formatStartTime(testRunSummary.StartTime),
                    testExecutionTimeInMs: (_a = testRunSummary.TestTime, (_a !== null && _a !== void 0 ? _a : 0)),
                    testTotalTimeInMs: (_b = testRunSummary.TestTime, (_b !== null && _b !== void 0 ? _b : 0)),
                    commandTimeInMs: utils_1.getCurrentTime() - commandStartTime,
            ...
            if (codeCoverage) {
                ...
                (_c = progress) === null || _c === void 0 ? void 0 : _c.report({
                    type: 'FormatTestResultProgress',
                ...
                result.summary.testRunCoverage = utils_2.calculatePercentage(coveredLines, totalLines);
    ...
    abortTestRun(testRunId, progress) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const testQueueItems = yield this.connection.tooling.autoFetchQuery(`SELECT Id, Status FROM ApexTestQueueItem WHERE ParentJobId = '${testRunId}'`);
