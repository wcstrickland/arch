...
class FrameStateUtil {
    ...
    static computeFrameName(fields) {
        ...
        switch (fields[1]) {
            ...
            case constants_1.EVENT_CODE_UNIT_FINISHED:
                if (sig.startsWith(constants_1.SFDC_TRIGGER)) {
                    frameName = sig.substring(constants_1.SFDC_TRIGGER.length);
                }
                else {
                    frameName = sig;
                }
    ...
    static isExtraneousVFGetterOrSetterLogLine(logLine) {
        const getMatch = ' get\\((.*)\\)';
        const setMatch = ' set\\((.*)\\)';
...
exports.FrameStateUtil = FrameStateUtil;
//# sourceMappingURL=frameStateUtil.js.map