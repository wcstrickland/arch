...
class StreamingClient extends lib_1.AsyncOptionalCreatable {
    ...
    handshake() {
        ...
        return new Promise((resolve, reject) => {
            timeout = setTimeout(() => {
                const timeoutError = sfdxError_1.SfdxError.create('@salesforce/core', 'streaming', StreamingClient.TimeoutErrorType.HANDSHAKE, [this.targetUrl]);
    ...
    subscribe(streamInit) {
        ...
        return new Promise((subscribeResolve, subscribeReject) => {
            ...
            return new Promise((subscriptionResolve, subscriptionReject) => {
                timeout = setTimeout(() => {
                    const timeoutError = sfdxError_1.SfdxError.create('@salesforce/core', 'streaming', StreamingClient.TimeoutErrorType.SUBSCRIBE);
                    this.doTimeout(timeout, timeoutError);
    ...
    class DefaultOptions {
        ...
        constructor(org, channel, streamProcessor, envDep = lib_1.env) {
            ...
            if (!(parseFloat(this.apiVersion) > 0)) {
                throw sfdxError_1.SfdxError.create('@salesforce/core', 'streaming', 'invalidApiVersion', [this.apiVersion]);
            }
