...
exports.SoqlCompletionErrorStrategy = void 0;
...
class SoqlCompletionErrorStrategy extends DefaultErrorStrategy_1.DefaultErrorStrategy {
    /**
    ...
    getErrorRecoverySet(recognizer) {
        ...
        if (recognizer.ruleContext.ruleIndex === SoqlParser_1.SoqlParser.RULE_soqlField) {
            const soqlFieldFollowSet = new IntervalSet_1.IntervalSet();
            soqlFieldFollowSet.add(SoqlLexer_1.SoqlLexer.COMMA);
            soqlFieldFollowSet.add(SoqlLexer_1.SoqlLexer.FROM);
...
exports.SoqlCompletionErrorStrategy = SoqlCompletionErrorStrategy;
//# sourceMappingURL=SoqlCompletionErrorStrategy.js.map