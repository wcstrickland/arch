...
function findDocumentHighlights(document, position, htmlDocument) {
    ...
    const endTagRange = typeof node.endTagStart === 'number' &&
        getTagNameRange(htmlScanner_1.TokenType.EndTag, document, node.endTagStart);
...
function covers(range, position) {
    return (isBeforeOrEqual(range.start, position) &&
