import { CompletionItem, CompletionList, Diagnostic, DocumentHighlight, DocumentLink, FormattingOptions, Hover, MarkedString, Position, Range, SymbolInformation, TextDocument, TextEdit } from 'vscode-languageserver-types';
