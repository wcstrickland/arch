...
function getDocumentRegions(languageService, document) {
    ...
    while (token !== salesforcedx_visualforce_markup_language_server_1.TokenType.EOS) {
        switch (token) {
            case salesforcedx_visualforce_markup_language_server_1.TokenType.StartTag:
                lastTagName = scanner.getTokenText();
                lastAttributeName = null;
                languageIdFromType = 'javascript';
                break;
            case salesforcedx_visualforce_markup_language_server_1.TokenType.Styles:
                regions.push({
                    languageId: 'css',
                ...
                break;
            case salesforcedx_visualforce_markup_language_server_1.TokenType.Script:
                regions.push({
                ...
                break;
            case salesforcedx_visualforce_markup_language_server_1.TokenType.AttributeName:
                lastAttributeName = scanner.getTokenText();
                break;
            case salesforcedx_visualforce_markup_language_server_1.TokenType.AttributeValue:
...
function getLanguageRanges(document, regions, range) {
    const result = [];
    let currentPos = range ? range.start : salesforcedx_visualforce_markup_language_server_1.Position.create(0, 0);
...
function getEmbeddedDocument(document, contents, languageId, ignoreAttributeValues) {
    ...
    return salesforcedx_visualforce_markup_language_server_1.TextDocument.create(document.uri, languageId, document.version, result);
}
