...
exports.messages = {
    ...
    streaming_handshake_timeout_text: 'Streaming API handshake failed due to a socket timeout. Check your connection and try again.',
    hotswap_warn_text: "You can't modify Apex classes or triggers during an Apex Debugger session. Save your changes after you're done debugging.",
    ...
    idle_warn_text: 'You have been idle for %s minutes. To prevent your debugger session from being terminated, run or step through code, or inspect your variables, in the next %s minutes.',
    idle_terminated_text: 'Your debugger session is being terminated because it has been idle for %s minutes.',
    invalid_isv_project_config: 'Your project configuration is invalid or incomplete for ISV debugging. Return to the Apex Debugger page in Setup, start a new partner debugging session, and try again.',
    unexpected_error_help_text: 'An unexpected error occurred while launching the debugger session. Refer to the Debug Console for details.'
};
