...
exports.messages = {
    ...
    error_static_resource_expected_archive_type: 'A StaticResource directory must have a content type of application/zip or application/jar - found %s for %s',
    error_static_resource_missing_resource_file: 'A StaticResource must have an associated .resource file, missing %s.resource-meta.xml',
