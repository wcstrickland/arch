...
exports.trimMetaXmlSuffix = exports.generateMetaXMLPath = exports.generateMetaXML = void 0;
...
function generateMetaXMLPath(sourcePath) {
    return sourcePath.endsWith(common_1.META_XML_SUFFIX) ? sourcePath : `${sourcePath}${common_1.META_XML_SUFFIX}`;
}
