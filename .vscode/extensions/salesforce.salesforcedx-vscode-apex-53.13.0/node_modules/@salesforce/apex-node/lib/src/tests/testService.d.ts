...
export declare class TestService {
     ...
     * @param token cancellation token
     */
    runTestAsynchronous(options: AsyncTestConfiguration | AsyncTestArrayConfiguration, codeCoverage?: boolean, exitOnTestRunId?: boolean, progress?: Progress<ApexTestProgressValue>, token?: CancellationToken): Promise<TestResult | TestRunIdResult>;
    /**
