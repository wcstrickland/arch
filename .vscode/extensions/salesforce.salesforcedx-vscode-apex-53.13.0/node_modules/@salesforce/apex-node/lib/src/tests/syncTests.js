    ...
    runTests(options, codeCoverage = false, token) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield this.formatSyncResults(testRun, utils_1.getCurrentTime(), codeCoverage);
            }
            catch (e) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = {
                summary: {
                    ...
                    skipped: 0,
                    passRate: utils_2.calculatePercentage(globalTestPassed, apiTestResult.numTestsRun),
                    failRate: utils_2.calculatePercentage(globalTestFailed, apiTestResult.numTestsRun),
                    skipRate: utils_2.calculatePercentage(0, apiTestResult.numTestsRun),
                    testStartTime: utils_1.formatStartTime(startTime),
                    ...
                    commandTimeInMs: utils_1.getCurrentTime() - startTime,
