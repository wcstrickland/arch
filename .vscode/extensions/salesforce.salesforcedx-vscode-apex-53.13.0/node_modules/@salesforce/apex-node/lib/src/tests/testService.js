...
class TestService {
     ...
     * @param token cancellation token
     */
    runTestAsynchronous(options, codeCoverage = false, exitOnTestRunId = false, progress, token) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.asyncService.runTests(options, codeCoverage, exitOnTestRunId, progress, token);
        });
    }
    /**
    ...
    writeResultFiles(result, outputDirConfig, codeCoverage = false) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
                ...
                for (const format of resultFormats) {
                    ...
                    switch (format) {
                        case types_1.ResultFormat.json:
                            fileMap.push({
                                path: path_1.join(dirPath, testRunId ? `test-result-${testRunId}.json` : `test-result.json`),
                        ...
                        case types_1.ResultFormat.tap:
                            ...
                            fileMap.push({
                                path: path_1.join(dirPath, `test-result-${testRunId}-tap.txt`),
                                content: tapResult
                            });
                            break;
                        case types_1.ResultFormat.junit:
                            ...
                            fileMap.push({
                                path: path_1.join(dirPath, testRunId
            ...
            if (codeCoverage) {
                ...
                fileMap.push({
                    path: path_1.join(dirPath, `test-result-${testRunId}-codecoverage.json`),
