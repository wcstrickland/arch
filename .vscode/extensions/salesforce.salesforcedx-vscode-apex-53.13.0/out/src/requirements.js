...
function resolveRequirements() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const javaMemory = vscode_1.workspace
            .getConfiguration()
    ...
    return new Promise((resolve, reject) => {
        ...
        if (javaHome) {
            ...
            if (isLocal(javaHome)) {
                ...
                return reject(messages_1.nls.localize('java_runtime_local_text', javaHome, constants_1.SET_JAVA_DOC_LINK));
            }
