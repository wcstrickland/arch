...
complete -c hwloc-ls -s i -l input -d 'Read topology from XML file <file> (instead of discovering the topology on th…'
...
complete -c hwloc-ls -l disallowed -d 'Include objects disallowed by administrative limitations'
